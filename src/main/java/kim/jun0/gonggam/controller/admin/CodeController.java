...
public class CodeController {
	...
	@PostMapping("")
	public ResponseEntity<String> createCode(@AuthenticationPrincipal UserDetails activeUser,
		...
		try {
			service.createCode(activeUser, vo);
	...
	@PutMapping("")
	public ResponseEntity<String> updateCode(@AuthenticationPrincipal UserDetails activeUser,
			@RequestBody CodeVo vo) {
		...
		try {
			service.updateCode(activeUser, vo);
